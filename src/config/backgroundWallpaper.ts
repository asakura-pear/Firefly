...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			...
			"assets/images/DesktopWallpaper/d11.jpg",
		],
		// 移动背景图片（支持单张或多张随机）
		...
		mobile: [
			...
			"assets/images/MobileWallpaper/m9.jpg",
			"assets/images/MobileWallpaper/m10.jpg",
			"assets/images/MobileWallpaper/m11.jpg",
			"assets/images/MobileWallpaper/m12.jpg",
		],
		// 背景视频播放地址
